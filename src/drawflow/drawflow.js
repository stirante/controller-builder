...
export default class Drawflow {
    ...
    getNodesForModule(moduleName) {
        return this.drawflow.drawflow[moduleName].data;
    }
    ...
    addNode (name, num_in, num_out, ele_pos_x, ele_pos_y, classoverride, data, html, typenode = false) {
        ...
        if(typenode === false) {
            ...
            let componentClass = this.render.extend(this.noderegister[html].html);
            componentInstance = new componentClass({...this.noderegister[html].options, propsData: data});
            componentInstance.$mount();
            content.appendChild(componentInstance.$el);
        }
        ...
        this.drawflow.drawflow[this.module].data[this.nodeId] = {
            id: this.nodeId,
            name: name,
            data: data,
            class: classoverride,
